  ...
  <table>
    <tr>
      <td width="33%">
        <div align="center">
          <h3>📚 Bookworm</h3>
          <p>Always exploring new worlds through pages</p>
        </div>
      </td>
      <td width="33%">
        <div align="center">
          <h3>💪 GymRat</h3>
          <p>Building muscles and optimizing code</p>
        </div>
      </td>
      <td width="33%">
        <div align="center">
          <h3>🐛 Bug Hunter</h3>
          <p>Finding and squashing bugs is my specialty</p>
        </div>
      </td>
    </tr>
  </table>
...
<div align="center">
  ...
  <a href="https://www.linkedin.com/in/nakuldevmv/" target="_blank">
